...
public enum Awakening {
    ...
    SKILLBOOST("Skill Boost", "SB", null), TPA("Two-Pronged Attack", "TPA", null), SBR("Resistance-Skill Bind", "SBR", null),
    ...
    FIREROW("Enhanced Fire Attribute", "FireRow", null), WATERROW("Enhanced Water Attribute", "WaterRow", null), WOODROW("Enhanced Wood Attribute", "WoodRow", null),
    LIGHTROW("Enhanced Light Attribute", "LightRow", null), DARKROW("Enhanced Dark Attribute", "DarkRow", null),
