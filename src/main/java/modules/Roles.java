...
public class Roles extends Module {
    ...
    protected Map<String, Command> makeCommands() {
        ...
        commands.put("db", db);
        commands.put("autorole", autorole);
        commands.put("removeautorole", removeautorole);
        commands.put("addrole", addrole);
        commands.put("ar", addrole);
        commands.put("removerole", removerole);
        commands.put("rr", removerole);
        commands.put("iam", iam);
        commands.put("iamn", iamn);
        commands.put("inrole", inrole);
        commands.put("roles", roles);
        commands.put("allroles", allroles);
        commands.put("lsar", lsar);
        commands.put("asar", asar);
        commands.put("rsar", rsar);
        commands.put("servertree", servertree);
